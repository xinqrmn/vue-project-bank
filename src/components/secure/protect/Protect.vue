...
import ProtectInner from '@/components/secure/protect/ProtectInner.vue';
</script>

<template>
  <section class="protect mb-36">
    <div class="container">
      <h3 class="title">
        How We <span class="text-primary"> Protect You </span>
      </h3>
      <p class="mb-20 w-4/5">
