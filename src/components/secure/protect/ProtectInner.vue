...
import ProtectItem from '@/components/secure/protect/ProtectItem.vue';
import {
  Square3Stack3DIcon,
  CurrencyRupeeIcon,
  SquaresPlusIcon,
...
<template>
  <div class="protect-inner flex flex-wrap justify-between gap-10">
    <div class="protect-decor"></div>
    <protect-item
