...
<template>
  <div class="reviews-top flex justify-between items-end mb-24">
    <div class="w-3/4">
      <h3 class="title">Our <span class="text-primary">Testimonials</span></h3>
      <p class="w-3/4">
    ...
    <ControlFace
      :boolean-variable="reviews.isInd"
      :click-func="reviews.changeCat"
    ></ControlFace>
  </div>
</template>
