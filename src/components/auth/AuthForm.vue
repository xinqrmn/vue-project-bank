  ...
  <form class="login__form" @submit.prevent="authStore.submitForm">
    <div class="login__inputs-inner">
      <div class="login__inputs-box" v-if="authStore.mode === 'register'">
        <input type="text" v-model="authStore.firstName" placeholder="Enter first name" class="login__input"
               required autocomplete="current-password"/>
        <ErrorMessage :error="authStore.errors.firstName"></ErrorMessage>
      </div>
      <div class="login__inputs-box" v-if="authStore.mode === 'register'">
        <input type="text" v-model="authStore.lastName" placeholder="Enter last name" class="login__input"
               required autocomplete="current-password"/>
    ...
    <div class="login__buttons-box">
      ...
      <button type="button" @click="authStore.setMode(authStore.mode === 'login' ? 'register' : 'login')" class="login__button login__button--secondary">
