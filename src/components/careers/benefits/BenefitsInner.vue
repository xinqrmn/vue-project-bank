...
import BenefitsItem from "@/components/careers/benefits/BenefitsItem.vue";
import {PresentationChartBarIcon, LightBulbIcon, BriefcaseIcon, InboxStackIcon} from '@heroicons/vue/24/solid'

</script>

<template>
  <div class="benefits-inner">
    <benefits-item title="Competitive Compensation"
    ...
    <benefits-item title="Health and Wellness"
    ...
    <benefits-item title="Retirement Planning"
    ...
    <benefits-item title="Work-Life Balance"
