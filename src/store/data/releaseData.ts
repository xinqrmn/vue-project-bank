import { IRelease } from '@/store/types/interfaces';
import ReleaseImageOne from '@/assets/img/release-1.jpg';
import ReleaseImageTwo from '@/assets/img/release-2.jpg';
